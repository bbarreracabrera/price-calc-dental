...
export const getWelcomeTemplate = (userName) => `
    <div style="font-family: sans-serif; color: #241F1B; max-width: 600px; margin: auto; border: 1px solid #D9D2C7; border-radius: 24px; padding: 40px;">
        ...
        <div style="margin: 30px 0;">
            <a href="https://shiningclouddental.cl" style="background-color: #46523C; color: white; padding: 12px 24px; border-radius: 12px; text-decoration: none; font-weight: bold; font-size: 14px;">Entrar a mi Clínica</a>
        </div>
        <hr style="border: 0; border-top: 1px solid #D9D2C7; margin: 30px 0;" />
        <p style="font-size: 12px; color: #5E554E;">Si no creaste esta cuenta, puedes ignorar este correo.</p>
    </div>
`;
