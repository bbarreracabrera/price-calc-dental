        ...
        <div className="space-y-6 animate-in fade-in h-full flex flex-col pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 pb-6 border-b border-[#D9D2C7]/50 shrink-0">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <Stethoscope size={14} className="text-[#8A7F74]"/>
                        <p className="text-[11px] font-black uppercase tracking-widest text-[#5E554E]">Documentos Clínicos</p>
                    </div>
                    <h2 className="text-4xl font-black text-[#241F1B] tracking-tighter">Recetario Clínico</h2>
                    <p className="text-xs font-bold text-[#5E554E] mt-1">Borrador interno para uso del profesional</p>
                </div>
                <div className="flex items-center gap-3">
                    <button
                        onClick={() => setShowLegalInfo(!showLegalInfo)}
                        className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-[#46523C]/30 bg-[#46523C]/5 text-[#46523C] text-[11px] font-black uppercase tracking-widest hover:bg-[#46523C]/10 transition-all"
                    >
                        <Shield size={13}/> Marco Legal
                    </button>
                    <button
                        onClick={() => window.open('https://recetaelectronica.minsal.cl/', '_blank')}
                        className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#241F1B] text-white text-[11px] font-black uppercase tracking-widest hover:bg-[#1a1512] transition-all shadow-md"
                    >
                        <ExternalLink size={13}/> Receta Electrónica MINSAL
                    </button>
                    <button 
                        onClick={() => { setPrescription([]); setRxPatient(null); setMedInput({name:'', dosage:''}); }}
                        className="px-4 py-2.5 rounded-xl border border-[#D9D2C7] bg-white text-[#5E554E] text-[11px] font-black uppercase tracking-widest hover:bg-[#FBFAF8] hover:text-[#241F1B] transition-all"
                    >
                        Limpiar
                    </button>
                </div>
            ...
            {showLegalInfo && (
                <div className="bg-blue-50 border border-blue-200 rounded-3xl p-6 animate-in slide-in-from-top-2 shrink-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="bg-white rounded-2xl p-4 border border-blue-100">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-widest text-[#241F1B]">Este módulo (Borrador PDF)</span>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl p-4 border border-green-100">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[11px] font-black uppercase tracking-widest text-[#241F1B]">Receta Electrónica Oficial (MINSAL)</span>
                            </div>
                            <p className="text-xs font-bold text-[#5E554E] leading-relaxed">
                    ...
                    <button
                        onClick={() => window.open('https://recetaelectronica.minsal.cl/', '_blank')}
                        className="mt-4 w-full flex items-center justify-center gap-2 py-3 bg-[#46523C] text-white font-black text-[11px] uppercase tracking-widest rounded-2xl hover:bg-[#36402F] transition-all"
                    >
            ...
            {!showLegalInfo && (
                <div className="flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-4 py-3 shrink-0">
                    ...
                    <button
                        onClick={() => window.open('https://recetaelectronica.minsal.cl/', '_blank')}
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-[#241F1B] text-white text-[11px] font-black uppercase tracking-widest rounded-xl whitespace-nowrap hover:bg-[#1a1512] transition-all"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start flex-1">
                ...
                <Card className="lg:col-span-7 space-y-6 rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                    ...
                    <div>
                        <label className="text-[11px] font-black uppercase tracking-widest text-[#5E554E] ml-2 mb-2 block">1. Paciente a recetar</label>
                    ...
                    {rxPatient && (
                        <div className="animate-in slide-in-from-top-2 pt-4">
                            ...
                            <div className="bg-[#FBFAF8] border border-[#D9D2C7]/50 p-5 rounded-2xl flex items-center justify-between mb-6 shadow-inner">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 rounded-full bg-[#46523C]/10 text-[#46523C] flex items-center justify-center font-black text-xl border border-[#46523C]/20">
                                        {rxPatient.personal?.legalName?.[0]?.toUpperCase() || '?'}
                                    </div>
                                    <div>
                                        <p className="font-black text-[#241F1B] text-lg leading-none mb-1">{rxPatient.personal?.legalName}</p>
                                        <p className="text-[11px] font-bold uppercase tracking-widest text-[#5E554E]">RUT: {rxPatient.personal?.rut || 'No registrado'}</p>
                                    </div>
                                </div>
                            ...
                            {medicalAlerts && (
                                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-2xl flex gap-3 animate-in zoom-in-95 shadow-sm">
                                    ...
                                    <div>
                                        <h4 className="text-[11px] font-black uppercase tracking-widest text-red-600 mb-1">Alerta Médica Activa</h4>
                                        <p className="text-sm font-bold text-red-900">{medicalAlerts}</p>
                                    </div>
                                </div>
                            )}

                            <label className="text-[11px] font-black uppercase tracking-widest text-[#5E554E] ml-2 mb-2 block border-t border-[#D9D2C7]/50 pt-6">2. Prescripción</label>
                            
                            <div className="space-y-4">
                                <div className="relative">
                                    <Pill className="absolute left-4 top-1/2 -translate-y-1/2 text-[#8A7F74]" size={18}/>
                                    <input 
                                        className="w-full p-4 pl-12 rounded-2xl bg-white border border-[#D9D2C7] outline-none font-bold text-[#241F1B] focus:border-[#46523C] transition-colors shadow-sm"
                                ...
                                <div className="relative">
                                    <input 
                                        className="w-full p-4 rounded-2xl bg-white border border-[#D9D2C7] outline-none font-bold text-[#241F1B] focus:border-[#46523C] transition-colors shadow-sm"
                                    ...
                                    />
                                    {showSuggestions && (
                                        <div className="absolute z-10 w-full mt-2 bg-white border border-[#D9D2C7] rounded-2xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2">
                                            {commonDosages.map((dosis, idx) => (
                                                <button 
                                                    key={idx} 
                                                    className="w-full text-left px-4 py-3 text-xs font-bold text-[#5E554E] hover:bg-[#FBFAF8] hover:text-[#46523C] border-b border-[#D9D2C7]/30 last:border-0 transition-colors"
                                ...
                                <button 
                                    className="w-full py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest text-white bg-[#241F1B] hover:bg-[#1a1512] shadow-lg shadow-[#241F1B]/20 active:scale-95 transition-all flex items-center justify-center gap-2"
                                    onClick={()=>{
                                        if(medInput.name) {
                                            setPrescription([...prescription, medInput]); 
                                            setMedInput({name:'', dosage:''});
                ...
                <div className="lg:col-span-5 space-y-4">
                    <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-[#FBFAF8] p-8 shadow-sm flex flex-col min-h-[400px]">
                        <div className="flex justify-between items-center mb-6 border-b border-[#D9D2C7]/50 pb-4">
                            <h3 className="font-black text-xl text-[#241F1B]">Vista Previa</h3>
                            <span className="text-[11px] font-black uppercase tracking-widest text-[#5E554E]">{getLocalDate()}</span>
                        </div>
                        
                        <div className="flex-1 space-y-4 max-h-[350px] overflow-y-auto custom-scrollbar pr-2 mb-6">
                            {prescription.length === 0 ? (
                                <div className="text-center py-10 opacity-50 flex flex-col items-center">
                                    <Stethoscope size={32} className="text-[#8A7F74] mb-3"/>
                                    <p className="text-xs font-bold uppercase tracking-widest">Receta en blanco</p>
                                </div>
                            ) : (
                                prescription.map((p,i)=>(
                                    <div key={i} className="p-4 bg-white rounded-2xl border border-[#D9D2C7]/50 shadow-sm relative group">
                                        <div className="flex items-start gap-3 pr-6">
                                            <div className="w-1.5 h-1.5 rounded-full bg-[#46523C] mt-1.5 shrink-0"></div>
                                            <div>
                                                <p className="font-black text-[#241F1B] text-sm leading-tight mb-1">{p.name}</p>
                                                <p className="text-xs text-[#5E554E] font-medium leading-relaxed">{p.dosage}</p>
                                            </div>
                                        </div>
                                        <button 
                                            className="absolute top-4 right-4 text-[#D9D2C7] hover:text-red-500 transition-colors" 
                        ...
                        <div className="pt-6 border-t border-[#D9D2C7]/60 mt-auto space-y-3">
                            <button 
                                ...
                                className={`w-full py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                                    ...
                                    ? 'bg-[#D9D2C7]/30 text-[#5E554E] cursor-not-allowed' 
                                    : 'bg-[#46523C] text-white hover:bg-[#36402F] shadow-lg shadow-[#46523C]/20 hover:-translate-y-0.5'
                                }`}
                            >
                            ...
                            <button
                                onClick={() => window.open('https://recetaelectronica.minsal.cl/', '_blank')}
                                className="w-full py-3 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-2 bg-white border border-[#46523C]/30 text-[#46523C] hover:bg-[#46523C]/5 transition-all"
                            >
