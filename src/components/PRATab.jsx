    ...
    return (
        <div className="space-y-4 animate-in fade-in">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-xl font-black text-[#241F1B]">Evaluación de Riesgo Periodontal</h2>
                    <p className="text-sm text-[#5E554E]">Lang &amp; Tonetti — Datos precargados desde la ficha</p>
                </div>
                <button
                                    ...
                                    <div className="border-t border-[#D9D2C7] bg-[#FBFAF8] p-4">
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                            {[
                                                ...
                                                <div key={label} className="bg-white rounded-xl p-2 border border-[#D9D2C7] text-center">
                                                    <p className="text-[11px] font-black uppercase tracking-widest text-[#5E554E]">{label}</p>
                                                    <p className="text-sm font-bold text-[#241F1B]">{val}</p>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
...
function PreflightPRA({ data, onCancel, onConfirm }) {
    return (
        <div className="bg-white rounded-3xl border border-[#D9D2C7] p-6">
            <h3 className="text-lg font-black text-[#241F1B] mb-2">Datos precargados desde la ficha</h3>
            <p className="text-sm text-[#5E554E] mb-4">
            ...
            {(data.age === 0 || data.teethCount === 0) && (
                <div className="bg-[#FBFAF8] border-l-4 border-[#D9A86C] rounded-r-xl p-3 mb-4">
