...
export default function SettingsView({
    ...
    const TEAM_COLORS = ['#46523C', '#8A7F74', '#D3A9A0', '#D9A86C', '#7A8B7F', '#B89B85', '#9B7E7A', '#6B7B6E'];
        ...
        <div className="space-y-8 animate-in fade-in h-full flex flex-col pb-10">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-end gap-6 pb-6 border-b border-[#D9D2C7]/50 shrink-0">
                <div>
                    <div className="flex items-center gap-2 mb-2">
                        <Settings size={14} className="text-[#8A7F74]"/>
                        <p className="text-[11px] font-black uppercase tracking-widest text-[#5E554E]">Administración</p>
                    </div>
                    <h2 className="text-4xl font-black text-[#241F1B] tracking-tighter">Ajustes de Clínica</h2>
                </div>
                {userRole === 'admin' && (
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 px-5 py-3.5 bg-[#FBFAF8] border border-[#D9D2C7] text-[#241F1B] font-black text-[11px] uppercase tracking-widest rounded-2xl hover:bg-[#D9D2C7]/30 transition-all"
                        >
                            Repetir tour
                        </button>
                        <button
                            ...
                            className="flex items-center gap-2 px-8 py-3.5 bg-[#241F1B] text-white font-black text-[11px] uppercase tracking-widest rounded-2xl hover:bg-[#1a1512] transition-all shadow-lg shadow-[#241F1B]/20 hover:-translate-y-0.5"
                        >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-8">
                {userRole === 'admin' ? (
                    <>
                        {/* --- IDENTIDAD VISUAL --- */}
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2">
                                <Camera className="text-[#D3A9A0]"/> Identidad Visual
                            </h3>
                            <div onClick={()=>logoInputRef.current.click()} className="w-full max-w-md p-8 border-2 border-dashed border-[#D9D2C7] bg-[#FBFAF8] rounded-[2rem] flex flex-col items-center justify-center cursor-pointer hover:bg-white hover:border-[#8A7F74] transition-all shadow-inner group">
                                ...
                                {config.logo ? (
                                    <div className="flex flex-col items-center gap-4">
                                        ...
                                        <span className="text-[11px] font-black uppercase tracking-widest text-[#8A7F74] bg-white px-4 py-1.5 rounded-full border border-[#D9D2C7]/50 shadow-sm">Cambiar Logo</span>
                                    </div>
                                ) : (
                                    <div className="flex flex-col items-center gap-3 opacity-60 group-hover:opacity-100 transition-opacity">
                                        <div className="w-16 h-16 rounded-full bg-white shadow-sm flex items-center justify-center text-[#8A7F74] border border-[#D9D2C7] group-hover:scale-110 transition-transform"><Camera size={28}/></div>
                                        <span className="text-[11px] font-black uppercase tracking-widest text-[#46523C]">Click para subir logo</span>
                                        <p className="text-xs font-bold text-[#5E554E]">Formato PNG transparente recomendado</p>
                                    </div>
                                )}
                            </div>
                        </Card>
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2 border-b border-[#D9D2C7]/50 pb-4">
                                <Building2 className="text-[#8A7F74]"/> Datos de la Clínica
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                
                                <div className="md:col-span-2 p-5 bg-indigo-50/50 border border-indigo-100 rounded-3xl mb-2">
                                    <div className="flex justify-between items-center mb-2 ml-2">
                                        <label className="text-[11px] font-black uppercase tracking-widest text-indigo-800/60 block">Link de Reservas (Slug)</label>
                                    </div>
                                    ...
                                    <p className="text-[11px] text-indigo-800/50 font-bold mt-3 ml-2 uppercase tracking-widest">
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2 border-b border-[#D9D2C7]/50 pb-4">
                                <MessageCircle className="text-[#46523C]"/> Plantillas de WhatsApp
                            </h3>
                            <p className="text-xs text-[#5E554E] font-bold mb-4">Configura los mensajes automáticos. El sistema abrirá WhatsApp Web/App con el texto listo para enviar.</p>
                            
                            <div className="bg-[#D3A9A0]/10 p-4 rounded-2xl border border-[#D3A9A0]/30 mb-6 flex items-center gap-3">
                                <span className="text-[11px] font-black uppercase tracking-widest text-[#D3A9A0]">Variables mágicas:</span>
                                <div className="flex gap-2 flex-wrap">
                                    <span className="bg-white px-2 py-1 rounded-md text-[11px] font-bold text-[#241F1B] shadow-sm">{'{paciente}'}</span>
                                    <span className="bg-white px-2 py-1 rounded-md text-[11px] font-bold text-[#241F1B] shadow-sm">{'{clinica}'}</span>
                                </div>
                            </div>
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2 border-b border-[#D9D2C7]/50 pb-4">
                                <Shield className="text-[#8A7F74]"/> Bioseguridad y Caducidad
                            </h3>
                            <p className="text-xs text-[#5E554E] font-bold mb-6">Ajusta los tiempos de caducidad del material estéril según el protocolo y tipo de envoltorio de tu clínica (Norma MINSAL).</p>
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-[#FBFAF8] p-8 shadow-inner">
                            <div className="flex justify-between items-center mb-6 border-b border-[#D9D2C7]/50 pb-4">
                                <div>
                                    <h3 className="font-black text-xl text-[#241F1B] flex items-center gap-2"><CalendarDays className="text-[#46523C]"/> Horarios de Atención Online</h3>
                                    <p className="text-xs text-[#5E554E] font-bold mt-1">Configura los bloques en los que los pacientes podrán agendar automáticamente.</p>
                                </div>
                            </div>
                            <div className="space-y-4">
                                {Object.keys(defaultSchedule).map((day) => (
                                    <div key={day} className={`flex flex-col xl:flex-row items-start xl:items-center gap-4 p-4 rounded-2xl border transition-colors ${schedule[day].active ? 'bg-white border-[#D9D2C7]/80 shadow-sm' : 'bg-stone-50 border-stone-200 opacity-60'}`}>
                                        <div className="flex items-center gap-3 w-40 shrink-0">
                                            <div className={`w-10 h-5 rounded-full flex items-center cursor-pointer transition-colors px-0.5 ${schedule[day].active ? 'bg-[#46523C]' : 'bg-stone-300'}`} onClick={() => handleScheduleChange(day, 'active', !schedule[day].active)}>
                                            ...
                                            <span className={`font-black text-sm ${schedule[day].active ? 'text-[#241F1B]' : 'text-[#5E554E]'}`}>{day}</span>
                                        </div>
                                        <div className={`flex flex-wrap md:flex-nowrap items-center gap-3 transition-opacity ${schedule[day].active ? 'opacity-100' : 'opacity-30 pointer-events-none'}`}>
                                            <div className="flex items-center gap-2 bg-[#FBFAF8] px-3 py-2 rounded-xl border border-[#D9D2C7]/50">
                                                <Clock size={12} className="text-[#8A7F74]"/><span className="text-[11px] font-black uppercase tracking-widest text-[#5E554E] mr-1">Mañana:</span>
                                                <input type="time" className="bg-transparent font-bold text-xs text-[#241F1B] outline-none" value={schedule[day].start1} onChange={(e) => handleScheduleChange(day, 'start1', e.target.value)} />
                                                <span className="text-[#D9D2C7] font-bold">-</span>
                                                <input type="time" className="bg-transparent font-bold text-xs text-[#241F1B] outline-none" value={schedule[day].end1} onChange={(e) => handleScheduleChange(day, 'end1', e.target.value)} />
                                            </div>
                                            <div className="flex items-center gap-2 bg-[#FBFAF8] px-3 py-2 rounded-xl border border-[#D9D2C7]/50">
                                                <Clock size={12} className="text-[#8A7F74]"/><span className="text-[11px] font-black uppercase tracking-widest text-[#5E554E] mr-1">Tarde:</span>
                                                <input type="time" className="bg-transparent font-bold text-xs text-[#241F1B] outline-none" value={schedule[day].start2} onChange={(e) => handleScheduleChange(day, 'start2', e.target.value)} />
                                                <span className="text-[#D9D2C7] font-bold">-</span>
                                                <input type="time" className="bg-transparent font-bold text-xs text-[#241F1B] outline-none" value={schedule[day].end2} onChange={(e) => handleScheduleChange(day, 'end2', e.target.value)} />
                                            </div>
                                        </div>
                                    </div>
                                ))}
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <div className="flex justify-between items-center mb-6 border-b border-[#D9D2C7]/50 pb-4">
                                <h3 className="font-black text-xl text-[#241F1B] flex items-center gap-2"><FileSignature className="text-[#46523C]"/> Información Legal para Recetas</h3>
                                <span className="text-[11px] font-black uppercase tracking-widest bg-[#FBFAF8] border border-[#D9D2C7] px-3 py-1 rounded-full text-[#5E554E]">Requisito MINSAL</span>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                ...
                                {/* Tamaño de papel de todos los PDF. Antes las coordenadas
                                    estaban escritas a mano sobre 210 mm de ancho, así que en
                                    Carta (215,9 mm) todo salía descuadrado a la izquierda. */}
                                <div>
                                    <label className={labelClass}>Tamaño de papel de los documentos</label>
                                    <select
                                        className={inputClass}
                                        value={config.paperFormat || 'a4'}
                                        onChange={e=>setConfigLocal({...config, paperFormat: e.target.value})}
                                    >
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2 border-b border-[#D9D2C7]/50 pb-4">
                                <FlaskConical className="text-[#46523C]"/> Directorio de Laboratorios
                            </h3>
                            
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 bg-[#FBFAF8] p-5 rounded-3xl border border-[#D9D2C7]/50 mb-8 shadow-inner items-end">
                                <div className="md:col-span-4 space-y-1">
                                    <label className={labelClass}>Nombre del Lab</label>
                                    <input className="w-full p-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="Ej: Lab Cerámico Sur" value={newLab.name} onChange={e=>setNewLab({...newLab, name:e.target.value})}/>
                                </div>
                                <div className="md:col-span-4 space-y-1">
                                    <label className={labelClass}>Correo (Acceso Online)</label>
                                    <div className="relative">
                                        <Mail size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#D9D2C7]" />
                                        <input className="w-full pl-10 pr-3 py-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="contacto@lab.com" value={newLab.email} onChange={e=>setNewLab({...newLab, email:e.target.value})}/>
                                    </div>
                                </div>
                                <div className="md:col-span-4 space-y-1">
                                    <label className={labelClass}>Teléfono (Opcional)</label>
                                    <div className="relative">
                                        <Phone size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#D9D2C7]" />
                                        <input className="w-full pl-10 pr-3 py-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="+56 9..." value={newLab.phone} onChange={e=>setNewLab({...newLab, phone:e.target.value})}/>
                                    </div>
                                </div>
                                <div className="md:col-span-12 mt-2">
                                    <button 
                                        className="w-full h-[50px] bg-[#D3A9A0] hover:bg-[#b09088] text-white rounded-xl font-black text-[11px] uppercase tracking-widest transition-all shadow-lg shadow-[#D3A9A0]/30 flex items-center justify-center gap-2"
                            ...
                            <div className="space-y-3">
                                ...
                                {laboratories.length === 0 ? (
                                    <p className="text-xs text-[#5E554E] font-bold py-4 text-center border-2 border-dashed border-[#D9D2C7] rounded-2xl bg-[#FBFAF8]">Aún no has registrado laboratorios.</p>
                                ) : (
                                    laboratories.map(lab => {
                                        ...
                                        return (
                                            <div key={lab.id} className="flex flex-col sm:flex-row sm:items-center gap-4 p-5 bg-white rounded-2xl border border-[#D9D2C7]/40 hover:border-[#46523C] transition-all shadow-sm">
                                                <div className="flex items-center gap-4 flex-1 min-w-0">
                                                    <div className="w-10 h-10 rounded-xl bg-[#46523C]/10 flex items-center justify-center text-[#46523C] shrink-0"><FlaskConical size={20}/></div>
                                                    <div className="min-w-0">
                                                        <div className="flex items-center gap-2 flex-wrap mb-1">
                                                            <p className="font-black text-[#241F1B] truncate">{lab.name}</p>
                                                            {lab.email && (isPending ? (
                                                                <span className="text-[11px] uppercase tracking-widest font-bold px-2 py-0.5 rounded-full bg-[#D9A86C]/20 text-[#9A6E2C] shrink-0">Pendiente</span>
                                                            ) : (
                                                                <span className="text-[11px] uppercase tracking-widest font-bold px-2 py-0.5 rounded-full bg-[#46523C]/20 text-[#46523C] shrink-0">Activo</span>
                                                            ))}
                                                        </div>
                                                        <div className="flex gap-3 flex-wrap">
                                                            {lab.email && <span className="text-[11px] font-bold text-[#5E554E] truncate">{lab.email}</span>}
                                                            {lab.phone && <span className="text-[11px] font-bold text-[#5E554E]">{lab.phone}</span>}
                                                        </div>
                                                        {lab.email && isPending && lab.invited_at && (
                                                            <p className="text-[11px] text-[#5E554E] mt-1">
                                                ...
                                                <div className="flex items-center gap-2 shrink-0">
                                                    {lab.email && isPending && (
                                                        <button
                                                            ...
                                                            className="flex items-center gap-1.5 px-3 py-2 text-[11px] font-black uppercase tracking-widest rounded-xl bg-[#241F1B] text-white hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
                                                        >
                                                            <Mail size={12}/> Reenviar
                                                        </button>
                                                    )}
                                                    <button onClick={() => handleDeleteLab(lab.id)} className="p-2 text-[#D9D2C7] hover:bg-red-50 hover:text-red-500 rounded-lg transition-all" title="Eliminar Laboratorio"><Trash2 size={18}/></button>
                                                </div>
                                            </div>
                                        );
                                    })
                        ...
                        {/* --- GESTIÓN DE EQUIPO --- */}
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <h3 className="font-black text-xl text-[#241F1B] mb-6 flex items-center gap-2 border-b border-[#D9D2C7]/50 pb-4"><Shield className="text-[#D3A9A0]"/> Gestión de Accesos y Equipo</h3>
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 bg-[#FBFAF8] p-5 rounded-3xl border border-[#D9D2C7]/50 mb-8 shadow-inner items-end">
                                <div className="md:col-span-3 space-y-1"><label className={labelClass}>Nombre</label><input className="w-full p-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="Nombre completo" value={newMember.name || ''} onChange={e=>setNewMember({...newMember, name:e.target.value})}/></div>
                                <div className="md:col-span-3 space-y-1"><label className={labelClass}>Correo Electrónico</label><input className="w-full p-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="usuario@clinica.com" value={newMember.email || ''} onChange={e=>setNewMember({...newMember, email:e.target.value})}/></div>
                                <div className="md:col-span-2 space-y-1">
                                    <label className={labelClass}>Rol</label>
                                    <select className="w-full p-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors appearance-none cursor-pointer" value={newMember.role || 'dentist'} onChange={e=>setNewMember({...newMember, role:e.target.value})}><option value="admin">Administrador</option><option value="dentist">Dentista</option><option value="assistant">Asistente</option></select>
                                </div>
                                <div className={`md:col-span-2 space-y-1 transition-opacity ${newMember.role === 'dentist' ? 'opacity-100' : 'opacity-30 pointer-events-none'}`}>
                                    ...
                                    <div className="relative">
                                        <Percent size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#D9D2C7]" />
                                        <input type="number" min="0" max="100" className="w-full pl-9 pr-3 py-3.5 rounded-xl bg-white border border-[#D9D2C7] outline-none font-bold text-sm text-[#241F1B] focus:border-[#46523C] transition-colors" placeholder="0" value={newMember.commission || ''} onChange={e=>setNewMember({...newMember, commission: Number(e.target.value)})}/>
                                    </div>
                                </div>
                                <div className="md:col-span-2">
                                    <button 
                                        className="w-full h-[50px] bg-[#46523C] hover:bg-[#36402F] text-white rounded-xl font-black text-[11px] uppercase tracking-widest transition-all shadow-lg shadow-[#46523C]/20 flex items-center justify-center gap-2"
                                        onClick={async()=>{
                            ...
                            <div className="space-y-3">
                                ...
                                {team.map(member => (
                                    <div key={member.id} className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 p-5 bg-white rounded-2xl border border-[#D9D2C7]/40 hover:border-[#8A7F74] transition-all shadow-sm group">
                                        <div className="flex items-center gap-4">
                                            <div className="color-picker-container relative shrink-0">
                                                <button
                                                    ...
                                                    style={{ backgroundColor: member.color || '#8A7F74' }}
                                                ...
                                                {colorPickerOpenFor === member.id && (
                                                    <div className="absolute z-50 top-12 left-0 bg-white rounded-2xl shadow-xl border border-[#D9D2C7] p-3 min-w-[180px]">
                                                        <p className="text-[11px] font-bold uppercase tracking-widest text-[#5E554E] mb-2 px-1">
                                                        ...
                                                        <div className="grid grid-cols-4 gap-2">
                                                            {TEAM_COLORS.map(color => (
                                                                <button
                                                                    ...
                                                                    className={`w-8 h-8 rounded-full border-2 transition-all hover:scale-110 ${member.color === color ? 'border-[#241F1B] scale-110' : 'border-white shadow-sm'}`}
                                            ...
                                            <div>
                                                <p className="font-black text-[#241F1B]">{member.name}</p>
                                                <p className="text-[11px] font-bold text-[#5E554E] mt-0.5">{member.email}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto">
                                            <div className="flex flex-col items-end gap-1">
                                                <span className={`text-[11px] uppercase font-black px-3 py-1.5 rounded-full border tracking-widest ${member.role === 'admin' ? 'bg-[#46523C]/10 text-[#46523C] border-[#46523C]/20' : member.role === 'dentist' ? 'bg-[#8A7F74]/10 text-[#8A7F74] border-[#8A7F74]/20' : member.role === 'lab' ? 'bg-blue-50 text-blue-600 border-blue-200' : 'bg-[#D3A9A0]/10 text-[#D3A9A0] border-[#D3A9A0]/20'}`}>
                                                    {member.role === 'admin' ? 'Administrador' : member.role === 'dentist' ? 'Odontólogo' : member.role === 'lab' ? 'Laboratorio' : 'Asistente'}
                                                </span>
                                                {member.role === 'dentist' && <span className="text-[11px] font-black text-[#5E554E] pr-2">Comisión: {member.commission || 0}%</span>}
                                            </div>
                                            <button 
                                                onClick={async()=>{ 
                                                ...
                                                className="p-2 text-[#D9D2C7] hover:bg-red-50 hover:text-red-500 rounded-lg transition-all" 
                        ...
                        <Card className="rounded-[2.5rem] border border-[#D9D2C7]/60 bg-white p-8 shadow-sm">
                            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-[#D9D2C7]/50">
                                <Ruler size={16} className="text-[#8A7F74]"/>
                                <h3 className="font-black text-xl text-[#241F1B] tracking-tight">Medición Radiográfica</h3>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] font-bold text-[#5E554E] mt-2 ml-1">Si no encuentras tu modelo exacto, selecciona el tamaño genérico más cercano.</p>
                                </div>

                                {config.sensorModel && (
                                    <div className="bg-[#FBFAF8] border border-[#D9D2C7] rounded-2xl p-4">
                                        <p className="text-[11px] font-black uppercase tracking-widest text-[#5E554E] mb-2">Sensor Configurado</p>
                                        <p className="font-bold text-[#241F1B]">
                        ...
                        <Card theme={themeMode} className="p-8">
                            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-[#D9D2C7]/50">
                                <CreditCard size={16} className="text-[#8A7F74]"/>
                                <h3 className="font-black text-xl text-[#241F1B] tracking-tight">Cobros con MercadoPago</h3>
                            </div>

                            {!config?.mp_access_token ? (
                                <div className="space-y-4">
                                    <p className="text-sm font-bold text-[#5E554E] leading-relaxed">
                                ...
                                <div className="space-y-5">
                                    <div className="flex items-center gap-2 px-4 py-3 bg-[#46523C]/10 border border-[#46523C]/20 rounded-2xl w-fit">
                                        <div className="w-2 h-2 rounded-full bg-[#46523C]"></div>
                                        <span className="text-sm font-black text-[#46523C]">Cuenta conectada</span>
                                    </div>

                                    <label className="flex items-center justify-between gap-4 p-5 bg-[#FBFAF8] border border-[#D9D2C7]/50 rounded-2xl cursor-pointer hover:border-[#8A7F74] transition-all">
                                        <div>
                                            <p className="font-black text-[#241F1B]">Cobro al agendar</p>
                                            <p className="text-xs font-bold text-[#5E554E] mt-1">Los pacientes deben pagar para confirmar su hora</p>
                                        </div>
                                        <div
                                            ...
                                            className={`relative w-12 h-6 rounded-full transition-colors cursor-pointer shrink-0 ${(config?.require_payment_at_booking === true || config?.require_payment_at_booking === 'true') ? 'bg-[#46523C]' : 'bg-[#D9D2C7]'}`}
                                        >
                                    ...
                                    <button
                                        ...
                                        className="text-[11px] font-black uppercase tracking-widest text-[#D3A9A0] hover:text-red-500 transition-colors"
                                    >
                                        Desconectar cuenta
                                    </button>
                                </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-20 opacity-50">
                        <Shield size={48} className="text-[#8A7F74] mb-4"/>
                        <h3 className="font-black text-xl text-[#241F1B]">Acceso Restringido</h3>
                        <p className="text-sm font-bold mt-2 text-[#5E554E]">Contacta al administrador para editar la configuración de la clínica.</p>
                    </div>
                )}
            </div>
        </div>
