  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-[#D9D2C7] rounded-2xl p-6 space-y-6">
        <h3 className="text-lg font-black text-[#241F1B]">Nuevo Registro Ortodóncico</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-xs font-black uppercase tracking-widest text-[#5E554E] block mb-2">Aparatología</label>
            <select
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-xs font-black uppercase tracking-widest text-[#5E554E] block mb-2">Tipo de Arco</label>
            <input
              type="text"
          ...
          <div>
            <label className="text-xs font-black uppercase tracking-widest text-[#5E554E] block mb-2">Calibre Arco</label>
            <input
              type="text"
        ...
        <div>
          <label className="text-xs font-black uppercase tracking-widest text-[#5E554E] block mb-2">Ángulos Cefalométricos</label>
          <div className="grid grid-cols-4 gap-2">
            <input
              ...
              className="px-3 py-2 border border-[#D9D2C7] rounded-lg text-xs focus:outline-none focus:border-[#46523C]"
            />
            <input
              type="number"
              placeholder="SNB"
        ...
        <div>
          <label className="text-xs font-black uppercase tracking-widest text-[#5E554E] block mb-2">Notas de Ajuste</label>
          <textarea
            ...
            className="w-full px-4 py-2 border border-[#D9D2C7] rounded-lg text-sm focus:outline-none focus:border-[#46523C] resize-none h-24"
          />
        </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 px-4 py-3 bg-[#46523C] text-white rounded-lg font-black text-xs uppercase tracking-widest hover:bg-[#36402F] transition-all flex items-center justify-center gap-2"
          >
            <Plus size={16} /> Guardar Registro
          </button>
          <button
            onClick={resetForm}
            className="px-4 py-3 bg-white border border-[#D9D2C7] text-[#5E554E] rounded-lg font-black text-xs uppercase tracking-widest hover:bg-[#FBFAF8] transition-all"
          >
            Limpiar
          </button>
        </div>
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-black text-[#241F1B]">Historial de Citas</h3>
        {records.length === 0 ? (
          <p className="text-sm text-[#5E554E] italic">No hay registros aún.</p>
        ) : (
          records.map((record) => (
            <div key={record.id} className="bg-white border border-[#D9D2C7] rounded-2xl p-4 space-y-3">
              <div className="flex justify-between items-start">
                <div>
                  <p className="font-black text-[#241F1B]">{new Date(record.date).toLocaleDateString('es-CL')}</p>
              ...
              {record.adjustmentNotes && (
                <p className="text-xs text-[#5E554E] bg-[#FBFAF8] p-3 rounded-lg">{record.adjustmentNotes}</p>
              )}
            </div>
          ))
        )}
