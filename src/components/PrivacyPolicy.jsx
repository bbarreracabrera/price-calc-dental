    ...
    return (
        <div className="min-h-screen bg-[#FBFAF8] text-[#241F1B] font-sans">
            <div className="max-w-2xl mx-auto px-6 py-12">
                <a
                    href="/"
                    className="inline-flex items-center gap-2 text-xs font-bold text-[#5E554E] hover:text-[#241F1B] mb-10 transition-colors"
                >
                    <ArrowLeft size={14}/> Volver
                </a>

                <div className="flex items-center gap-3 mb-8">
                    <div className="w-10 h-10 bg-[#46523C]/10 rounded-2xl flex items-center justify-center">
                        <Shield size={20} className="text-[#46523C]"/>
                    </div>
                    <div>
                        <h1 className="text-2xl font-black tracking-tighter">Política de Privacidad</h1>
                        <p className="text-[11px] font-bold uppercase tracking-widest text-[#5E554E] mt-0.5">ShiningCloud Dental · Vigente desde Enero 2025</p>
                    </div>
                </div>
                ...
                <div className="space-y-8 text-sm leading-relaxed text-[#4a3f38]">
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">1. Responsable del Tratamiento</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">2. Datos que Recopilamos</h2>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">3. Finalidad del Tratamiento</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">4. Base Legal</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">5. Conservación de Datos</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">6. Sus Derechos</h2>
                    ...
                    <section>
                        <h2 className="font-black text-[#241F1B] text-base mb-2">7. Seguridad</h2>
                        <p>
                ...
                <div className="mt-12 pt-6 border-t border-[#D9D2C7]/50 text-[11px] font-bold text-[#5E554E] uppercase tracking-widest">
